      ...
      <div className="space-y-2 pt-6 pb-4 md:space-y-5">
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            Hey👋, Welcome to my personal website!<br/>
            I am a Full-Stack Mobile Developer with a specialization in {' '}
            <a
            ...
            currently dedicated to crafting intelligent AI-based applications at {' '}
            <a
              ...
              href="https://www.wecrunch.com/"
              rel="noreferrer"
              target="_blank"
            >
              WeCrunch
            </a>{' '}
            With a passion for innovation and a track record of delivering excellence, I strive to create immersive digital experiences that push the boundaries of what's possible. Explore my portfolio and let's bring your ideas to life!
          </p>
        </p>
        <div className="mt-8 flex flex-wrap gap-4 text-center">
          <a
            ...
            href="https://www.linkedin.com/in/taberzameer"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            ...
            href="mailto:tbzameer@gmail.com"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
          ...
          <a
            className="focusable flex flex-none cursor-pointer items-center justify-center gap-2 rounded-md bg-blue-500 py-2 px-2.5 font-medium text-white shadow-lg shadow-blue-500/10 transition selection:bg-white/30 hover:bg-blue-500/80 hover:shadow-blue-500/5 focus:ring-blue-500/40 dark:bg-blue-400 dark:text-zinc-900 dark:shadow-blue-400/10 dark:selection:bg-zinc-900/30 dark:hover:bg-blue-400/80 dark:hover:shadow-blue-400/5 dark:focus:ring-blue-400/40 sm:w-auto sm:px-3 sm:pl-2.5"
            href="https://twitter.com/TaberZameer"
            rel="noreferrer"
            target="_blank"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content mt-12 sm:mt-24">
        ...
        <ul className="mt-8">
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            ...
            >
              <Image
                src="/static/images/workxp/wecrunch.png"
                alt="Octopia"
                width="50px"
                height="50px"
          ...
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://q-sols.com/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/q-sols.png"
                alt="Octopia"
                width="50px"
                height="50px"
                className="rounded-md"
          ...
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://www.tech-stead.com/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/techstead.png"
                alt="Octopia"
                width="50px"
                height="50px"
                className="rounded-md"
          ...
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            <a
              className="link focusable font-medium text-zinc-800 dark:text-white"
              href="https://www.linkedin.com/company/synapsex/"
              rel="noreferrer"
              target="_blank"
            >
              <Image
                src="/static/images/workxp/synapsex.png"
                alt="Octopia"
                width="50px"
                height="50px"
                className="rounded-md"
